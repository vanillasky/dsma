...
public class DefaultWordAnalyzerTest {
    ...
    public void test() throws Exception {
        ...
        List<AnalysisResult> result = wa.analyzeWord(new Eojeol(word, CharType.HANGUL, 0));
    ...
    public void test_AnalyzedWords() throws Exception {
        String word = "텐데";
        WordAnalyzer wa = new DefaultWordAnalyzer();
        List<AnalysisResult> results = wa.analyzeWord(new Eojeol(word, CharType.HANGUL, 0));
