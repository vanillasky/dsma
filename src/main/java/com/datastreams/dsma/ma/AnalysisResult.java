...
//    private List<CompoundEntry> compound = new ArrayList<CompoundEntry>(); // compound noun of input word
    ...
    public AnalysisResult(String stem, String josa, String eomi, int patn) {
    ...
    public AnalysisResult(String stem, String josa, String eomi, int patn, int score) {
        this(stem,josa,eomi,patn);
        this.score = score;
    }

    public AnalysisResult(String stem, String josa, String eomi, char pos, int patn, int score) {
...
//    }
    ...
    public AnalysisResult clone() throws CloneNotSupportedException {
        AnalysisResult output = (AnalysisResult)super.clone();
