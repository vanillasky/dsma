...
public class SyllableUtil {
     ...
     * @throws Exception
     */
    public static char[] getFeature(char syl) throws Exception {
     ...
     * @throws Exception
     */
    public static char[] getFeature(int idx)  throws Exception {
    ...
    private static List getSyllableFeature() throws Exception {

        try{
            Syllables = new ArrayList<char[]>();

            List<String> line = FileUtil.readLines("/dic/syllable.dic","UTF-8");
