...
import kr.co.datastreams.dsma.ma.analyzer.CachableMorphemeAnalyzer;
...
import kr.co.datastreams.dsma.ma.tokenizer.SentenceSeparator;
...
public class AnalysisJob {
    ...
    private AnalysisJob(String document, SentenceSeparator separator, Tokenizer tokenizer, int numOfThreads, boolean useCache, boolean useWordCounting) {
        ...
        this.analyzer = useCache ? new CachableMorphemeAnalyzer(tokenizer, wordCounter) : new MorphemeAnalyzer(tokenizer, wordCounter);
    ...
    // java.util.concurrent.CompletionService 에게 분석할 문장을 제출한다.
