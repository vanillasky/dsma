...
public class CachableMorphemeAnalyzer extends MorphemeAnalyzer {
    ...
    public CachableMorphemeAnalyzer(Tokenizer tokenizer) {
        this(tokenizer, null);
    }

    public CachableMorphemeAnalyzer(Tokenizer tokenizer, WordCounter wordCounter) {
        super(tokenizer, wordCounter);
