 ...
 */
public class EndingEndsWithHi extends BaseEndingCombineRule {


    public EndingEndsWithHi(String stemCandidate, String endingCandidate) {
        super(stemCandidate, endingCandidate);
    }

    @Override
    public boolean canHandle() {
        return lastCharInStemPart == '히' && EomiDic.exists("이" + endingPart);
    }
